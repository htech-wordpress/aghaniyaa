...
import { Home, Briefcase, Building2, Landmark, RefreshCcw, Percent } from 'lucide-react';
          ...
          <Card className="border-0 shadow-2xl bg-white overflow-hidden rounded-2xl">
            <CardHeader className="bg-slate-50 border-b border-slate-100 pb-0 pt-0 px-0">
              <Tabs value={loanType} onValueChange={setLoanType} className="w-full">
                <TabsList className="w-full h-auto p-0 bg-transparent grid grid-cols-2 lg:grid-cols-3 gap-1">
                  <TabsTrigger
                    value="personal"
                    className="flex flex-col md:flex-row items-center justify-center gap-2 py-4 md:py-6 rounded-none data-[state=active]:bg-white data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:text-primary data-[state=active]:shadow-none text-slate-500 font-medium text-xs md:text-base transition-all"
                  >
                  ...
                  >
                    ...
                    <span>Transfer Home Loan</span>
                  </TabsTrigger>
                  <TabsTrigger
                    value="transfer-property"
                    className="flex flex-col md:flex-row items-center justify-center gap-2 py-4 md:py-6 rounded-none data-[state=active]:bg-white data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:text-primary data-[state=active]:shadow-none text-slate-500 font-medium text-xs md:text-base transition-all"
                  >
                    <Percent className="h-5 w-5 md:h-6 md:w-6" />
                    <span>Transfer Property Loan</span>
                  </TabsTrigger>
                </TabsList>
              </Tabs>
            </CardHeader>
