                ...
                <div className="container mx-auto px-4 text-center">
                    <ScrollAnimation direction="fade" delay={0.2}>
                        ...
                        <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                            Don't just take our word for it. Hear what our satisfied customers have to say about their experience with AGHANIYA ENTERPRISES.
                        </p>
                    </ScrollAnimation>
                </div>
            </div>
                ...
                <ScrollAnimation direction="fade" delay={0.6}>
                    <div className="mt-20 text-center bg-white rounded-2xl p-10 shadow-lg border border-slate-100 max-w-4xl mx-auto">
                        ...
                        <p className="text-slate-600 mb-8 max-w-2xl mx-auto">
                            Join thousands of happy customers who have trusted AGHANIYA ENTERPRISES for their financial needs.
                        </p>
