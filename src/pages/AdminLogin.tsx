...
import { signInWithGoogle, isSuperUser, isAdminUser } from '@/lib/firebase';
...
export function AdminLogin() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (user) {
        // Check if user is authorized (either defined admin or superuser)
        ...
        if (admin || superUser) {
          ...
          // Optionally sign them out immediately if you want strictly no session
          // await signOutUser(); 
        }
      }
    } catch (err: any) {
