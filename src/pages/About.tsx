          ...
          <ScrollAnimation direction="right" delay={0.2}>
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-slate-100">
              ...
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                <p>
                  At <span className="font-semibold text-slate-800">AGHANIYA</span>, we are committed to helping clients reach their financial objectives with tailored solutions.
          ...
          <ScrollAnimation direction="scale" delay={0.5}>
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-slate-100">
              <div className="text-center mb-10">
                <h2 className="text-3xl font-bold text-slate-800 mb-2">Why Choose AGHANIYA?</h2>
                <p className="text-slate-500">The advantages that set us apart</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  "25+ years of industry experience",
                  "Partnerships with 275+ financial institutions",
                  "PAN India presence in 4,000+ cities",
