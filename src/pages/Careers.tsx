      ...
      <div className="bg-hero-gradient py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          <ScrollAnimation direction="fade" delay={0.2}>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Careers at AGHANIYA</h1>
        ...
        <ScrollAnimation direction="left" delay={0.2}>
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-slate-100 mb-16">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-800">Build Your Career with AGHANIYA</h2>
            </div>
